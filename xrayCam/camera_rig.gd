...
func _process(delta):
	background_camera.global_transform = GameManager.rpgPlayer.camera_point.global_transform
	foreground_camera.global_transform = GameManager.rpgPlayer.camera_point.global_transform
